...
public class Client extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            //Menuliskan IP Server serta penentuan Port yang ingin di gunakan
            socket = new Socket(txtIp.getText().trim(), 9999);
            txt.append("Connect success ...\n");
            //Kinerja system lebih ringan
            // dikarenakan system hanya perlu 
            // menuliskan dalam bentuk Object 
            // yang di serialkan di java
            // tidak byte
            out = new ObjectOutputStream(socket.getOutputStream());
            Data data = new Data();
            data.setStatus("new");
            //data.setName("Laing raven");
            data.setName("From Client");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        try {
            //Melakukan pemilihan file/data yang ingin kita kirimkan
            JFileChooser ch = new JFileChooser();
            int c = ch.showOpenDialog(this);
            if (c == JFileChooser.APPROVE_OPTION) {
                //menentukan file yg ingin di kirim dari folder yg kita inginkan.
                File f = ch.getSelectedFile();
                //digunakan untuk membaca barisan setiap byte pada file.
                FileInputStream in = new FileInputStream(f);
                //untuk menyimpan tiap byte pada file
                // agar dapat di representasikan menjadi
                // String begitu juga sebaliknya.
